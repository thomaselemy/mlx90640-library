...
examples = test rawrgb step fbuf interp interpbw video hotspot sdlscale 
...
$(BUILD_DIR)interpbw: $(SRC_DIR)interpbw.o $(LIB_DIR)interpolate.o $(LIB_DIR)fb.o libMLX90640_API.a
	$(CXX) -L/home/pi/mlx90640-library $^ -o $@ $(I2C_LIBS)
